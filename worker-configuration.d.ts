/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f83146b1408ae626ade64be07f7b5356)
...
interface __BaseEnv_Env {
	...
	MAYAR_GATE: DurableObjectNamespace<import("./src/server").MayarGate>;
	RATE_LIMITER: DurableObjectNamespace<import("./src/server").RateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "MayarGate" | "RateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAYAR_ENV" | "MAYAR_API_URL" | "APP_URL" | "MAYAR_API_KEY">> {}
}
