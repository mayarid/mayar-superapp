...
const DESCRIPTION =
  "Delapan cara menagih dengan satu API. Pilih berdasarkan bagaimana uangnya masuk, bukan berdasarkan apa yang kamu jual."

export const Route = createFileRoute("/")({
  component: IndexPage,
  head: () => ({
    meta: [
      { title: "Delapan cara menagih — Mayar Superapp" },
      { name: "description", content: DESCRIPTION },
      {
        property: "og:title",
        content: "Delapan cara menagih — Mayar Superapp",
      },
      ...
      <main className="mx-auto flex w-full max-w-4xl flex-col gap-10 px-6 py-14">
        <header className="flex max-w-[62ch] flex-col gap-4">
          ...
          <p className="leading-relaxed text-pretty text-muted-foreground">
            ...
            halaman di sini memakai checkout milik sendiri, mengutamakan QRIS,
            dan berjalan di lingkungan produksi dengan uang sungguhan.
          </p>
        </header>
        ...
        <p className="max-w-[62ch] text-sm leading-relaxed text-muted-foreground">
          Tiga model dijual lewat tier, dan endpoint tagihannya menghitung
          nominal dari tier itu tanpa menerima penimpaan — jadi kupon hanya
          berlaku di lima model lainnya. Batas seperti ini sengaja ditampilkan,
          bukan disembunyikan.
        </p>
      </main>
      <SiteFooter />
